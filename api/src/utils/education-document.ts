...
/**
 * Generate a filled education application document
 */
export function generateEducationDocument(data: EducationData): Buffer {
  const templatePath = path.join(__dirname, '..', 'templates', 'Yacht education.docx');
