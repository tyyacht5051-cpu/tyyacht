      ...
      <ul class="nav-menu" :class="{ active: isMenuOpen }">
        ...
        <li class="nav-item dropdown" :class="{ active: isDropdownOpen }" @mouseenter="showDropdown" @mouseleave="hideDropdown">
          ...
          <ul class="dropdown-menu" :class="{ active: isDropdownOpen }">
            ...
            <li><router-link to="/cruise-education" class="dropdown-link">크루즈 요트 교육</router-link></li>
            <li><router-link to="/cruise-experience" class="dropdown-link">크루즈 요트 체험</router-link></li>
