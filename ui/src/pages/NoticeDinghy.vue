        ...
        <section class="content-section">
            <div class="container">
                ...
                <div class="notices-table">
                    ...
                    <router-link v-for="notice in paginatedNotices" :key="notice.id" :to="`/notice/dinghy/${notice.id}`" class="table-row title-link" :class="{ 'important-row': notice.important }">
    ...
    methods: {
        ...
        async loadNotices() {
            try {
                ...
                console.error('딩기요트 공지사항 로드 실패:', error);
        ...
        async submitNotice() {
            ...
            try {
                ...
                formData.append('category_id', 'dinghy');
        ...
        async createNewPage() {
            try {
                ...
                this.$router.push(`/notice/dinghy/edit/${draftId}`);
            } catch (error) {
