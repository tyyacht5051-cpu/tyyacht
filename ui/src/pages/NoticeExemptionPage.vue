    ...
    <div class="notice-page">
        <section class="hero-section">
            ...
            <div class="hero-content">
                <h1 class="hero-title">{{ notice.title || '면제교육 공지사항' }}</h1>
                <p class="hero-subtitle">면제교육 관련 중요 공지사항입니다</p>
            </div>
        </section>
        ...
        <section class="content-section">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span class="separator">></span>
                    <router-link to="/notice/exemption">면제교육</router-link>
                    <span class="separator">></span>
                ...
                <div v-else class="public-mode">
                    ...
                    <div v-else-if="notice.title" class="notice-content">
                        <div class="notice-header">
                            <div class="category-badge exemption">📋 면제교육</div>
...
export default {
    ...
    computed: {
        isEditMode() {
            return this.$route.name === 'NoticeExemptionEdit';
        },
        canEdit() {
    ...
    async mounted() {
        ...
        if (this.isEditMode) {
            if (!this.canEdit) {
                ...
                this.$router.push('/notice/exemption');
                return;
            }
        }
    ...
    methods: {
        ...
        async saveNotice() {
            try {
                ...
                formData.append('category_id', 'exemption');
                ...
                // 저장 후 공개 모드로 전환
                this.$router.push(`/notice/exemption/${this.noticeId}`);
            } catch (error) {
        ...
        enterEditMode() {
            this.$router.push(`/notice/exemption/edit/${this.noticeId}`);
        },
