  ...
  <div class="privacy-container">
    <div class="privacy-content">
      ...
      <div class="privacy-section">
        ...
        <p>통영요트학교(이하 "회사")는 다음의 목적을 위하여 개인정보를 처리합니다. 처리한 개인정보는 다음의 목적 이외의 용도로는 사용되지 않으며, 이용 목적이 변경될 시에는 사전동의를 구할 예정입니다.</p>
        <ul>
          <li><strong>홈페이지 회원 가입 및 관리:</strong> 회원 가입의사 확인, 회원제 서비스 제공에 따른 본인 식별·인증, 회원자격 유지·관리, 제한적 본인확인제 시행에 따른 본인확인, 서비스 부정이용 방지, 만 14세 미만 아동 개인정보 수집 시 법정대리인 동의여부 확인, 각종 고지·통지, 고충처리 목적으로 개인정보를 처리합니다.</li>
          <li><strong>재화 또는 서비스 제공:</strong> 요트 교육 서비스 제공, 콘텐츠 제공, 맞춤서비스 제공, 본인인증, 연령인증, 요금결제·정산, 채권추심 목적으로 개인정보를 처리합니다.</li>
          <li><strong>고충처리:</strong> 민원인의 신원 확인, 민원사항 확인, 사실조사를 위한 연락·통지, 처리결과 통보 목적으로 개인정보를 처리합니다.</li>
        </ul>
      </div>
      ...
      <div class="privacy-section">
        ...
        <ul>
          <li><strong>홈페이지 회원가입 및 관리:</strong> 사이트 탈퇴 시까지 (다만, 다음의 사유에 해당하는 경우에는 해당 기간 종료 시까지)
            <ul>
          ...
          <li><strong>재화 또는 서비스 제공:</strong> 재화·서비스 공급완료 및 요금결제·정산 완료 시까지 (다만, 다음의 사유에 해당하는 경우에는 해당 기간 종료 시까지)
            <ul>
              <li>소비자보호에 관한 법률에 따른 표시·광고, 계약내용 및 이행 등에 관한 기록: 3년</li>
              <li>소비자보호에 관한 법률에 따른 소비자 불만 또는 분쟁처리에 관한 기록: 3년</li>
      ...
      <div class="privacy-section">
        ...
        <ul>
          <li><strong>홈페이지 회원가입 및 관리</strong>
            <ul>
              <li>필수항목: 아이디, 비밀번호, 이메일, 이름</li>
              <li>선택항목: 전화번호, 생년월일, 성별</li>
            </ul>
          </li>
          <li><strong>인터넷 서비스 이용과정에서 자동 생성되는 개인정보</strong>
            <ul>
      ...
      <div class="privacy-section">
        ...
        <p>회사는 개인정보를 개인정보의 수집 목적으로 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.</p>
      </div>
      ...
      <div class="privacy-section">
        ...
        <ul>
          <li><strong>웹호스팅 서비스</strong>
            <ul>
              <li>위탁받는 자(수탁자): 호스팅 업체</li>
              <li>위탁하는 업무의 내용: 홈페이지 시스템 관리 및 운영</li>
            </ul>
          </li>
        </ul>
      ...
      <div class="privacy-section">
        ...
        <p>위의 권리 행사는 회사에 대해 개인정보 보호법 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 회사는 이에 대해 지체 없이 조치하겠습니다.</p>
      </div>
      ...
      <div class="privacy-section">
        ...
        <div class="contact-info">
          ...
          <ul>
            <li>성명: 서성덕</li>
            <li>직책: 개인정보보호담당자</li>
            <li>연락처: 055-641-5051~2</li>
            <li>이메일: ty6415051@hanmail.net</li>
          </ul>
      ...
      <div class="privacy-footer">
        ...
        <p>개인정보 처리방침에 대해 궁금한 사항이 있으시면 통영요트학교로 문의해 주시기 바랍니다.</p>
      </div>
