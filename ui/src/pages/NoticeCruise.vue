    ...
    <div class="notice-cruise">
        <section class="hero-section">
            ...
            <div class="hero-content">
                <h1 class="hero-title">크루저요트 공지사항</h1>
                <p class="hero-subtitle">크루저요트 교육 및 체험 관련 공지사항을 확인하세요</p>
            </div>
        </section>
    ...
    methods: {
        ...
        async loadNotices() {
            try {
                ...
                console.error('크루저요트 공지사항 로드 실패:', error);
