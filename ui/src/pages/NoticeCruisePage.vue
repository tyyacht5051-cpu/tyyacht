    ...
    <div class="notice-page">
        <section class="hero-section">
            ...
            <div class="hero-content">
                <h1 class="hero-title">{{ notice.title || '크루저요트 공지사항' }}</h1>
                <p class="hero-subtitle">크루저요트 관련 중요 공지사항입니다</p>
            </div>
        </section>
        ...
        <section class="content-section">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span class="separator">></span>
                    <router-link to="/notice/cruise">크루저요트</router-link>
                    <span class="separator">></span>
...
export default {
    ...
    computed: {
        isEditMode() {
            return this.$route.name === 'NoticeCruiseEdit';
        },
        canEdit() {
    ...
    methods: {
        ...
        async saveNotice() {
            try {
                ...
                this.$router.push(`/notice/cruise/${this.noticeId}`);
            } catch (error) {
        ...
        enterEditMode() {
            this.$router.push(`/notice/cruise/edit/${this.noticeId}`);
        },
