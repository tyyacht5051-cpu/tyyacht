    ...
    <div class="notice-page">
        <section class="hero-section">
            ...
            <div class="hero-content">
                <h1 class="hero-title">{{ notice.title || '기타 공지사항' }}</h1>
                <p class="hero-subtitle">기타 중요 공지사항입니다</p>
            </div>
        </section>
        ...
        <section class="content-section">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span class="separator">></span>
                    <router-link to="/notice/others">기타</router-link>
                    <span class="separator">></span>
                ...
                <div v-else class="public-mode">
                    ...
                    <div v-else-if="notice.title" class="notice-content">
                        <div class="notice-header">
                            <div class="category-badge others">📄 기타</div>
...
export default {
    ...
    computed: {
        isEditMode() {
            return this.$route.name === 'NoticeOthersEdit';
        },
        canEdit() {
    ...
    async mounted() {
        ...
        if (this.isEditMode) {
            if (!this.canEdit) {
                ...
                this.$router.push('/notice/others');
                return;
            }
        }
    ...
    methods: {
        ...
        async saveNotice() {
            try {
                ...
                this.$router.push(`/notice/others/${this.noticeId}`);
            } catch (error) {
        ...
        enterEditMode() {
            this.$router.push(`/notice/others/edit/${this.noticeId}`);
        },
        ...
        goBack() {
            ...
            this.$router.push('/notice/cruise');
        }
    }
};
</script>
