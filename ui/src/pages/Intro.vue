<template>
  <div class="intro-page">
      ...
      <div class="container">
        ...
        <div class="content-section">
          ...
          <div class="greeting-content">
            <p>남해안 해양 문화의 중심지인 우리 통영은 도내에서 최초로 정규 요트 계류 및 부대시설의 인프라를 갖추고</p>
            <p>요트 대중화와 이를 통한 해양 관광 활성화를 위하여 통영요트학교를 개교하게 되었습니다.</p>
          </div>
        </div>
        <!-- 찾아오시는 길 섹션 -->
        <div class="content-section">
    ...
    <div class="facility-images">
      <div class="facility-image" v-for="(image, index) in facilityImages" :key="index">
        <img :src="image.src" :alt="image.alt" v-if="image.src" />
        <div class="placeholder-image" v-else>
          <svg class="facility-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="yacht-subsection">
      ...
      <div class="cruise-yacht-gallery">
        <div class="cruise-yacht-row" v-for="(row, rowIndex) in cruiseYachtImages" :key="rowIndex">
          <div class="cruise-yacht-image" v-for="(image, imageIndex) in row" :key="imageIndex">
            <img :src="image.src" :alt="image.alt" v-if="image.src" />
            <div class="placeholder-image" v-else>
              <svg class="yacht-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="yacht-subsection">
      ...
      <div class="dinghy-yacht-gallery">
        <div class="dinghy-yacht-image" v-for="(image, index) in dinghyYachtImages" :key="index">
          <img :src="image.src" :alt="image.alt" v-if="image.src" />
          <div class="placeholder-image" v-else>
            <svg class="yacht-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="yacht-subsection">
      ...
      <div class="rescue-boat-gallery">
        <div class="rescue-boat-image">
          <img :src="rescueBoatImage.src" :alt="rescueBoatImage.alt" v-if="rescueBoatImage.src" />
          <div class="placeholder-image" v-else>
            <svg class="yacht-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const loadCruiseYachtImages = () => {
  const cruiseYachtPaths = [
    '/images/cruise1.JPG', '/images/cruise2.jpg',
    '/images/cruise3.png',
    '/images/cruise5.png', '/images/cruise6.JPG'
  ]
