<template>
    <div class="notice-recruitment">
        <section class="hero-section">
            <div class="hero-background"></div>
            <div class="hero-overlay"></div>
            <div class="hero-content">
                <h1 class="hero-title">채용 공지사항</h1>
                <p class="hero-subtitle">통영요트학교 채용 및 모집 공고를 확인하세요</p>
            </div>
        </section>
        ...
        <section class="content-section">
            <div class="container">
                ...
                <div class="notices-table">
                    ...
                    <router-link v-for="notice in paginatedNotices" :key="notice.id" :to="`/notice/recruitment/${notice.id}`" class="table-row title-link" :class="{ 'important-row': notice.important }">
    ...
    methods: {
        ...
        async loadNotices() {
            try {
                ...
                console.error('채용 공지사항 로드 실패:', error);
        ...
        async createNewPage() {
            try {
                ...
                this.$router.push(`/notice/recruitment/edit/${draftId}`);
            } catch (error) {
...
<style scoped>
.notice-recruitment { padding-top: 70px; }
...
.current { color: #6f42c1; font-weight: 600; }
.total-count { color: #6f42c1; font-weight: 600; }
...
.table-row { display: grid; grid-template-columns: 80px 1fr 120px 80px; padding: 15px; border-bottom: 1px solid #f9f9f9; cursor: pointer; transition: all 0.3s; }
...
.write-btn { padding: 10px 20px; background: #6f42c1; color: white; border: none; border-radius: 8px; cursor: pointer; }
.write-form { background: white; border: 2px solid #6f42c1; border-radius: 15px; padding: 30px; margin-top: 30px; }
.form-header { display: flex; justify-content: space-between; margin-bottom: 25px; }
.form-header h3 { color: #6f42c1; margin: 0; }
...
.submit-btn { padding: 12px 24px; background: #6f42c1; color: white; border: none; border-radius: 25px; cursor: pointer; }
...
.back-btn:hover { background: #6f42c1; color: white; border-color: #6f42c1; }
